      ...
      <Row gutter={[24, 0]}>
        ...
        {new_users_owner?.indexOf("Phòng sản xuất") !== -1 ? (
          <Col xs={12} xl={6} className="mb-24">
            <div>
              <Card
                onClick={() => handleClick("/blog/process_class")}
                hoverable
                style={{ width: "100%" }}
                cover={
                  <img
        ...
        {new_users_owner?.indexOf("Phòng Kinh doanh") !== -1 ? (
          <Col xs={12} xl={6} className="mb-24">
            <div>
              <Card
                onClick={() => handleClick("/blog/science_class")}
                hoverable
                style={{ width: "100%" }}
                cover={
                  <img
        ...
        {new_users_owner?.indexOf("Phòng hành chính nhân sự") !== -1 ? (
          <Col xs={12} xl={6} className="mb-24">
            <div>
              <Card
                onClick={() => handleClick("/blog/recruit_class")}
                hoverable
                style={{ width: "100%" }}
                cover={
                  <img
      ...
      <Row gutter={[24, 0]}>
        {new_users_owner?.indexOf("Phòng kế toán quản trị") !== -1 ? (
          <Col xs={12} xl={6} className="mb-24">
            <div>
              <Card
                onClick={() => handleClick("/blog/train_class")}
                hoverable
                style={{ width: "100%" }}
                cover={
                  <img
        ...
        {new_users_owner?.indexOf("Ban kiểm soát") !== -1 ? (
          <Col xs={12} xl={6} className="mb-24">
            <div>
              <Card
                onClick={() => handleClick("/blog/project_class")}
                hoverable
                style={{ width: "100%" }}
                cover={
                  <img
        ...
        {new_users_owner?.indexOf("Phòng kế hoạch") !== -1 ? (
          <Col xs={12} xl={6} className="mb-24">
            <div>
              <Card
                onClick={() => handleClick("/blog/blog_info")}
                hoverable
                style={{ width: "100%" }}
                cover={
                  <img
