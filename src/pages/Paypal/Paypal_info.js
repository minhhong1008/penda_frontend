import {
  ...
  import { postPaypalInfo, getPaypalInfo } from "../../api/paypal/index";
  const Paypal_info = () => {
    ...
    const onFinish = async (values) => {
      ...
      const data = await postPaypalInfo(values);
      console.log(data);
    };
    ...
    const getInfoPaypal = async () => {
      const { data } = await getPaypalInfo(id);
      let newData = {};
      //newData.status = data.status.split(",");
      newData.paypal_id = data.paypal_id;
            ...
            <Row gutter={16}>
                ...
                <Card title="THÔNG TIN paypal">
                  ...
                  >
                    <Row gutter={16}>
                      ...
                      <Col span={12}>
                        <Form.Item label="paypal Pass" name="paypal_password">
                          <Input size="small" placeholder="input here" />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Form.Item label="Loại paypal" name="paypal_types">
                      <Select
                        mode="multiple"
                        style={{ width: "100%" }}
                        placeholder="select one item"
                        optionLabelProp="label"
                      >
                        <Option value="paypal Buyer" label="Buyer">
                          <div className="demo-option-label-item">paypal Buyer</div>
                        </Option>
                        <Option value="paypal Seller" label="Seller">
                    ...
                    <Form.Item label="TT Bán" name="paypal_sell_status">
                      <Select
                        mode="multiple"
                        style={{ width: "100%" }}
                        placeholder="select one item"
                    ...
                    <Form.Item label="Quy trình" name="paypal_outline">
                      <Select
                        mode="multiple"
                        style={{ width: "100%" }}
                        placeholder="select one item"
              ...
              <Col span={12}>
                <Card title="THÔNG TIN TÀI NGUYÊN">
                  <Form>
                    <Form.Item label="Tài nguyên" name="paypal_material">
                      <Select
                        mode="multiple"
                        style={{ width: "100%" }}
                        placeholder="select one item"
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="paypal Info" name="info_paypal">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="paypal Phone" name="phone_paypal">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="paypal Mail" name="mail_paypal">
                          <Input
                            size="small"
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="paypal Bank" name="bank_paypal">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="paypal Device" name="device_paypal">
                          <Input size="small" placeholder="PC06" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="paypal Vbox" name="device_vbox">
                    ...
                    <Row gutter={16}>
                      ...
                      <Col span={8}>
                        <Form.Item label="paypal Listed" name="paypal_listed">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Phí Order" name="paypal_fees">
                          <Input placeholder="25%" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Handing time" name="paypal_handing_time">
                          <Input placeholder="10" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Lợi nhuận" name="paypal_profit">
          ...
          <Tabs.TabPane tab="LỊCH SỬ" key="2">
            <Row gutter={16}>
              <Col span={12}>
                <Card title="THỜI GIAN">
                  ...
                  >
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày tạo" name="paypaldate_creat">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày verify" name="paypaldate_verify">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày seller" name="paypaldate_seller">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày list 1" name="paypaldate_list1">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 2" name="paypaldate_list2">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 3" name="paypaldate_list3">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày list 4" name="paypaldate_list4">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 5" name="paypaldate_list5">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 6" name="paypaldate_list6">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày suspend" name="paypaldate_suspended">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày chat" name="paypaldate_contact">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày khôi phục" name="paypaldate_restore">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày lên lớp" name="paypaldate_class">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      ...
                      <Col span={8}>
                        <Form.Item
                          label="YC seller"
                          name="paypaldate_request_upseller"
                        >
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
              ...
              <Col span={12}>
                <Card title="LỊCH SỬ">
                  <Row gutter={16}>
                    <Form.Item name="paypal_note" label="Ghi chú">
                      <Input.TextArea />
                    </Form.Item>
                  </Row>
  
                  <span>
                    Lớp 1 => Lớp 2 | Thế Minh Hồng, 2022-11-24 00:01:42 57 => paypal
