...
export const listselect_device_block = [
  "Team 1",
  "Team 2",
  "Team 3",
  "Team 4",
...
export const listselect_device_owner = [
  "Phòng sản xuất",
  "Phòng phục hồi",
  "Phòng Kinh doanh",
  "Phòng nâng cấp",
...
export const tablelist_device_Date = [
  {
    title: "Ngày giao",
  ...
  },
  {
    ...
    value: "devicedate_moveroom",
  },

  {
    title: "Dự kiến seller",
    value: "devicedate_calendarseller",
  },
  {
    title: "Dự kiến list 1",
    value: "devicedate_calendarlist1",
  },
  {
    title: "Dự kiến list 2",
    value: "devicedate_calendarlist2",
  },
  {
    title: "Dự kiến list 3",
    value: "devicedate_calendarlist3",
  },
  {
    title: "Dự kiến list 4",
    value: "devicedate_calendarlist4",
  },
  {
    title: "Dự kiến list 5",
    value: "devicedate_calendarlist5",
  },
  {
    title: "Ngày error",
    value: "devicedate_error",
  },
  {
    title: "Ngày restrict",
    value: "devicedate_restrict",
  },
  {
...
export const listselect_device_fields = [];


export const HuongDanDevice_info = () => {
  return (
    <div>
...
export const HuongDanDevice_table = () => {
  return (
    <div>
      <p>1. Ebay mã EB_12345</p>
      <p>
...
export const HuongDanDevice_class = () => {
  return (
    <div>
      <p>1. Ebay mã EB_12345</p>
      <p>
