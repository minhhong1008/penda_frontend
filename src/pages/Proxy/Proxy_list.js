...
export const listselect_proxy_error = ["Xong","Không login", "Sai pass","Không về code","Không thấy sim"];

export const listselect_proxy_processing = [
  "Login mail",
  "Verify Mail",
  "Buyer",
  "View",
...
export const listselect_proxy_plan = [
  "Phone",
  "PC",
  "Antidetect",
  "Gologin",
...
export const listselect_proxy_block = [
  "Team 1",
  "Team 2",
  "Team 3",
  "Team 4",
...
export const listselect_proxy_type = [
  "VN",
  "US",
  "VPN",
  "Proxy Server",
...
export const listselect_proxy_sell_status = [
  "Đang chuẩn bị",
  "Đủ điều kiện bán",
  "Bán tài khoản",
  "Đang giao dịch",
...
export const listselect_proxy_owner = [
  "Phòng sản xuất",
  "Phòng phục hồi",
  "Phòng Kinh doanh",
  "Phòng nâng cấp",
...
export const listselect_proxy_status = [
    "Null",
  "Live",
  "Active",
  "Error",
...
export const listselect_proxy_class = [
  {
    title: "Lớp 1 New",
    value: "Lớp 1",
  },
...
export const tablelist_proxy_Date = [
  {
    title: "Ngày giao",
  ...
  },
  {
    ...
    value: "proxydate_moveroom",
  },

  {
    title: "Dự kiến seller",
    value: "proxydate_calendarseller",
  },
  {
    title: "Dự kiến list 1",
    value: "proxydate_calendarlist1",
  },
  {
    title: "Dự kiến list 2",
    value: "proxydate_calendarlist2",
  },
  {
    title: "Dự kiến list 3",
    value: "proxydate_calendarlist3",
  },
  {
    title: "Dự kiến list 4",
    value: "proxydate_calendarlist4",
  },
  {
    title: "Dự kiến list 5",
    value: "proxydate_calendarlist5",
  },
  {
    title: "Ngày error",
    value: "proxydate_error",
  },
  {
    title: "Ngày restrict",
    value: "proxydate_restrict",
  },
  {
...
export const listselect_proxy_fields = [];


export const HuongDanProxy_info = () => {
  return (
    <div>
      <p> Ở vị trí là người đang có nhu cầu sử dụng dịch vụ proxy, chúng ta thường thấy 3 loại proxy phổ biến sau đây</p>
      <p>
        1. Proxy Datacenter: Hay thường được giới thiệu là proxy cố định, những máy chủ proxy này được đặt tại những trung tâm dữ liệu (Datacenter). Khi sử dụng dịch vụ proxy này, các bạn sẽ thấy địa chỉ IP sẽ không thay đổi trong suốt quá trình sử dụng.
      </p>
      <p>
        2. Proxy Dân Cư (Residential Proxy) : Là loại proxy sử dụng đường truyền và địa chỉ IP từ các nhà cung cấp dịch vụ internet và sử dụng đường truyền ADSL, Cáp quang được đăng ký sử dụng bởi hộ gia đình, khu dân cư, văn phòng,...
      </p>
      <p>
        3. Mobile Proxy : Mobile Proxy là loại proxy sử dụng đường truyền và địa chỉ IP của các nhà cung cấp dịch vụ di động như Viettel, Vinaphone, Mobifone sử dụng sóng di động 4G, 5G thông qua các thiết bị đầu cuối là trạm phát BTS và Thẻ Sim được gắn trên các thiết bị di động.
      </p>
...
export const HuongDanProxy_table = () => {
  return (
    <div>
...
export const HuongDanProxy_class = () => {
  return (
    <div>
      <p>1. Ebay mã EB_12345</p>
      <p>
