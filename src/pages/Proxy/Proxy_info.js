  ...
  const proxy_info = () => {
    ...
    const onFinish = async (values) => {
      const newValue = {
        ...
        proxydate_start: dateData?.proxy_date_start
          ? moment(dateData.proxy_date_start).format("MM-DD-YYYY")
          : "",
        proxydate_verify: dateData?.proxy_date_verify
          ? moment(dateData.proxy_date_verify).format("MM-DD-YYYY")
          : "",
    ...
    const getInfoproxy = async () => {
      const { data } = await getproxyInfo(id);
      const newData = {
        ...data,
      ...
      dateForm.setFieldsValue({
        proxy_date_start: moment(data.proxy_date_start),
        proxy_date_verify: moment(data.proxy_date_verify),
      });
      setInfo(data);
    ...
    const listInfo = [
      ...
      },
      {
        title: "BANK",
        thumbnail:
          "https://previews.123rf.com/images/alexwhite/alexwhite1609/alexwhite160904656/62626176-proxy-flat-design-yellow-round-web-icon.jpg",
        value: "",
      },
      {
        title: "PAYONEER",
      ...
      },
      {
        title: "PAYPAL",
        thumbnail:
          "https://www.nicepng.com/png/detail/826-8264643_proxy-logo-png-instagram-icon-png-circle.png",
        value: "",
      },
      {
        title: "PINGPONG",
    ...
    const listDate = [
      {
        title: "Ngày giao",
        value: "proxydate_delivery",
      },
      {
        title: "Ngày tạo",
        value: "proxydate_start",
      },
      {
        title: "Ngày chuyển lớp",
        value: "proxydate_nextclass",
      },
      {
        title: "Ngày verify",
        value: "proxydate_verify",
      },
      {
        title: "Ngày Seller",
        value: "proxydate_seller",
      },
      {
        title: "Ngày verify Bank",
        value: "proxydate_verifybank",
      },
      {
        title: "Ngày draft",
        value: "proxydate_draft",
      },
      {
        title: "Ngày list1",
        value: "proxydate_list1",
      },
      {
        title: "Ngày list2",
        value: "proxydate_list2",
      },
      {
        title: "Ngày list3",
        value: "proxydate_list3",
      },
      {
        title: "Ngày list4",
        value: "proxydate_list4",
      },
      {
        title: "Ngày list5",
        value: "proxydate_list5",
      },
  
      {
        title: "Dự kiến seller",
        value: "proxydate_expectedseller",
      },
      {
        title: "Dự kiến list 1",
        value: "proxydate_expectedlist1",
      },
      {
        title: "Dự kiến list 2",
        value: "proxydate_expectedlist2",
      },
      {
        title: "Dự kiến list 3",
        value: "proxydate_expectedlist3",
      },
      {
        title: "Dự kiến list 4",
        value: "proxydate_expectedlist4",
      },
      {
        title: "Dự kiến list 5",
        value: "proxydate_expectedlist5",
      },
  
      {
        title: "Ngày Suspended",
        value: "proxydate_suspended",
      },
      {
        title: "Ngày check",
        value: "proxydate_checksus1",
      },
      {
        title: "Ngày gỡ sus 1",
        value: "proxydate_contact1",
      },
      {
        title: "Ngày gỡ sus 2",
        value: "proxydate_contact2",
      },
      {
        title: "Ngày gỡ sus 3",
        value: "proxydate_contact3",
      },
      {
        title: "Ngày gỡ sus 4",
        value: "proxydate_contact4",
      },
      {
        title: "Ngày gỡ sus 5",
        value: "proxydate_contact5",
      },
      {
        title: "Ngày check",
        value: "proxydate_checksus2",
      },
      {
        title: "Ngày check",
        value: "proxydate_checksus3",
      },
    ];
              ...
              <Col span={12}>
                <Card title="THÔNG TIN ETSY">
                  ...
                  >
                    <Row gutter={16}>
                      <Col span={6}>
                        <Form.Item
                          ...
                          onClick={() =>
                            copyToClipboard(form.getFieldValue("proxy_id"))
                          }
                        >
                          <Input
                            disabled={true}
                      ...
                      <Col span={10}>
                        <Form.Item label="proxy User" name="proxy_user">
                          <Input size="small" placeholder="input here" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="proxy Pass" name="proxy_password">
                          <Input size="small" placeholder="input here" />
                        </Form.Item>
                      </Col>
                    </Row>
                    <Row gutter={16}>
                      <Col span={24}>
                        <Form.Item label="proxy chi tiết" name="proxy_detail">
                          <Input size="small" placeholder="input here" />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={6}>
                        <Form.Item label="Tổng tiền" name="proxy_limit">
                          <Input size="small" placeholder="0" />
                        </Form.Item>
                      </Col>
                      <Col span={6}>
                        <Form.Item label="Đang hold" name="proxy_item">
                          <Input size="small" placeholder="0" />
                        </Form.Item>
                      </Col>
                      <Col span={6}>
                        <Form.Item label="Cần rút" name="proxy_sold">
                          <Input size="small" placeholder="0" />
                        </Form.Item>
                      </Col>
                      <Col span={6}>
                        <Form.Item label="Đã rút" name="proxy_feedback">
                          <Input size="small" placeholder="0" />
                        </Form.Item>
                      </Col>
                    </Row>
                      ...
                      <Col span={8}>
                        <Form.Item label="Lớp proxy" name="proxy_class">
                          ...
                          >
                            ...
                            <Option value="Lớp 20" label="Lớp 20 proxy error">
                              <div className="demo-option-label-item">
                                Lớp 20 proxy error
                              </div>
                            </Option>
