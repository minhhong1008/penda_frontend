import {
  ...
  import { postTiktokInfo, getTiktokInfo } from "../../api/tiktok/index";
  const Tiktok_info = () => {
    ...
    const onFinish = async (values) => {
      ...
      const data = await postTiktokInfo(values);
      console.log(data);
    };
    ...
    const getInfoTiktok = async () => {
      ...
      newData.tiktok_id = data.tiktok_id;
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Card title="THÔNG TIN tiktok">
                  ...
                  >
                    ...
                    <Form.Item label="Loại tiktok" name="tiktok_types">
                      <Select
                        mode="multiple"
                        style={{ width: "100%" }}
                        placeholder="select one item"
                      ...
                      >
                        <Option value="tiktok Buyer" label="Buyer">
                          <div className="demo-option-label-item">tiktok Buyer</div>
                        </Option>
                    ...
                    <Form.Item label="Quy trình" name="tiktok_outline">
                      <Select
                        mode="multiple"
                        style={{ width: "100%" }}
                        placeholder="select one item"
              ...
              <Col span={12}>
                <Card title="THÔNG TIN TÀI NGUYÊN">
                  <Form>
                    <Form.Item label="Tài nguyên" name="tiktok_material">
                      <Select
                        mode="multiple"
                        style={{ width: "100%" }}
                        placeholder="select one item"
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="tiktok Info" name="info_tiktok">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="tiktok Phone" name="phone_tiktok">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="tiktok Mail" name="mail_tiktok">
                          <Input
                            size="small"
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="tiktok Bank" name="bank_tiktok">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="tiktok Device" name="device_tiktok">
                          <Input size="small" placeholder="PC06" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="tiktok Vbox" name="device_vbox">
                    ...
                    <Row gutter={16}>
                      ...
                      <Col span={8}>
                        <Form.Item label="tiktok Listed" name="tiktok_listed">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Phí Order" name="tiktok_fees">
                          <Input placeholder="25%" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Handing time" name="tiktok_handing_time">
                          <Input placeholder="10" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Lợi nhuận" name="tiktok_profit">
          ...
          <Tabs.TabPane tab="LỊCH SỬ" key="2">
            <Row gutter={16}>
              <Col span={12}>
                <Card title="THỜI GIAN">
                  ...
                  >
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày tạo" name="tiktokdate_creat">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày verify" name="tiktokdate_verify">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày seller" name="tiktokdate_seller">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày list 1" name="tiktokdate_list1">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 2" name="tiktokdate_list2">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 3" name="tiktokdate_list3">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày list 4" name="tiktokdate_list4">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 5" name="tiktokdate_list5">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 6" name="tiktokdate_list6">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày suspend" name="tiktokdate_suspended">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày chat" name="tiktokdate_contact">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày khôi phục" name="tiktokdate_restore">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày lên lớp" name="tiktokdate_class">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      ...
                      <Col span={8}>
                        <Form.Item
                          label="YC seller"
                          name="tiktokdate_request_upseller"
                        >
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
              ...
              <Col span={12}>
                <Card title="LỊCH SỬ">
                  <Row gutter={16}>
                    <Form.Item name="tiktok_note" label="Ghi chú">
                      <Input.TextArea />
                    </Form.Item>
                  </Row>
  
                  <span>
                    Lớp 1 => Lớp 2 | Thế Minh Hồng, 2022-11-24 00:01:42 57 => tiktok
