...
export const listselect_tiktok_error = ["Không login", "Sai pass","Không về code","Không thấy sim"];

export const listselect_tiktok_processing = [
  "Login mail",
  "Verify Mail",
  "Buyer",
  "View",
...
export const listselect_tiktok_plan = [
  "Phone",
  "PC",
  "Antidetect",
  "Gologin",
...
export const listselect_tiktok_block = [
  "Team 1",
  "Team 2",
  "Team 3",
  "Team 4",
...
export const listselect_tiktok_type = [
  "VN",
  "US",
  "Buyer",
  "Kick Sold",
...
export const listselect_tiktok_sell_status = [
  "Đang chuẩn bị",
  "Đủ điều kiện bán",
  "Bán tài khoản",
  "Đang giao dịch",
...
export const listselect_tiktok_owner = [
  "Phòng sản xuất",
  "Phòng phục hồi",
  "Phòng Kinh doanh",
  "Phòng nâng cấp",
...
export const listselect_tiktok_status = [
    "Null",
  "Live",
  "Active",
  "Error",
...
export const listselect_tiktok_class = [
  {
    title: "Lớp 1 New",
    value: "Lớp 1",
  },
...
export const tablelist_tiktok_Date = [
  {
    title: "Ngày giao",
  ...
  },
  {
    ...
    value: "tiktokdate_moveroom",
  },

  {
    title: "Dự kiến seller",
    value: "tiktokdate_calendarseller",
  },
  {
    title: "Dự kiến list 1",
    value: "tiktokdate_calendarlist1",
  },
  {
    title: "Dự kiến list 2",
    value: "tiktokdate_calendarlist2",
  },
  {
    title: "Dự kiến list 3",
    value: "tiktokdate_calendarlist3",
  },
  {
    title: "Dự kiến list 4",
    value: "tiktokdate_calendarlist4",
  },
  {
    title: "Dự kiến list 5",
    value: "tiktokdate_calendarlist5",
  },
  {
    title: "Ngày error",
    value: "tiktokdate_error",
  },
  {
    title: "Ngày restrict",
    value: "tiktokdate_restrict",
  },
  {
...
export const listselect_tiktok_fields = [];


export const HuongDanTiktok_info = () => {
  return (
    <div>
...
export const HuongDanTiktok_table = () => {
  return (
    <div>
      <p>1. Ebay mã EB_12345</p>
      <p>
...
export const HuongDanTiktok_class = () => {
  return (
    <div>
      <p>1. Ebay mã EB_12345</p>
      <p>
