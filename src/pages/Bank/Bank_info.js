            ...
            <Row gutter={16}>
              <Col span={12}>
                <Card title="THÔNG TIN bank">
                  ...
                  >
                    ...
                    <Form.Item label="Loại bank" name="bank_types">
                      ...
                      >
                        <Option value="bank Buyer" label="Buyer">
                          <div className="demo-option-label-item">bank Buyer</div>
                        </Option>
                    ...
                    <Form.Item label="Quy trình" name="bank_outline">
                      <Select
                        mode="multiple"
                        style={{ width: "100%" }}
                        placeholder="select one item"
              ...
              <Col span={12}>
                <Card title="THÔNG TIN TÀI NGUYÊN">
                  <Form>
                    <Form.Item label="Tài nguyên" name="bank_material">
                      <Select
                        mode="multiple"
                        style={{ width: "100%" }}
                        placeholder="select one item"
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="bank Info" name="info_bank">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="bank Phone" name="phone_bank">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="bank Mail" name="mail_bank">
                          <Input
                            size="small"
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="bank Bank" name="bank_bank">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="bank Device" name="device_bank">
                          <Input size="small" placeholder="PC06" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="bank Vbox" name="device_vbox">
                    ...
                    <Row gutter={16}>
                      ...
                      <Col span={8}>
                        <Form.Item label="bank Listed" name="bank_listed">
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Phí Order" name="bank_fees">
                          <Input placeholder="25%" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Handing time" name="bank_handing_time">
                          <Input placeholder="10" />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Lợi nhuận" name="bank_profit">
            ...
            <Row gutter={16}>
                ...
                <Card title="THỜI GIAN">
                  ...
                  >
                    <Row gutter={16}>
                      ...
                      <Col span={8}>
                        <Form.Item label="Ngày seller" name="bankdate_seller">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày list 1" name="bankdate_list1">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 2" name="bankdate_list2">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 3" name="bankdate_list3">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày list 4" name="bankdate_list4">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 5" name="bankdate_list5">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày list 6" name="bankdate_list6">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày suspend" name="bankdate_suspended">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày chat" name="bankdate_contact">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      <Col span={8}>
                        <Form.Item label="Ngày khôi phục" name="bankdate_restore">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={8}>
                        <Form.Item label="Ngày lên lớp" name="bankdate_class">
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
                      ...
                      <Col span={8}>
                        <Form.Item
                          label="YC seller"
                          name="bankdate_request_upseller"
                        >
                          <DatePicker format={"DD/MM/YYYY"} />
                        </Form.Item>
                      </Col>
              ...
              <Col span={12}>
                <Card title="LỊCH SỬ">
                  ...
                  <span>
                    Lớp 1 => Lớp 2 | Thế Minh Hồng, 2022-11-24 00:01:42 57 => bank
