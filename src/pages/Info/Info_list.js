...
export const listselect_info_plan = [
  "Phone",
  "PC",
  "Antidetect",
  "Gologin",
...
export const listselect_info_block = [
  "Team 1",
  "Team 2",
  "Team 3",
  "Team 4",
...
export const listselect_info_owner = [
  "Phòng sản xuất",
  "Phòng phục hồi",
  "Phòng Kinh doanh",
  "Phòng nâng cấp",
...
export const listselect_info_class = [
  {
    title: "Lớp 1 New",
    value: "Lớp 1",
  },
...
export const tablelist_info_Date = [
  {
    title: "Ngày giao",
    value: "infodate_delivery",
  },
  {
...
export const HuongDanInfo_info = () => {
  return (
    <div>
      <p>1. Info mã EB_12345</p>
      <p>
        1. Info được tạo từ tool - nhập liệu - Chọn INFO, bảng bên cạnh nhập
      ...
      <p>
        ...
        hoạch được tạo khi tạo mã Info từ tool nhập liệu
      </p>
      <p>
...
export const HuongDanInfo_table = () => {
  return (
    <div>
      <p>1. Info mã EB_12345</p>
      <p>
...
export const HuongDanInfo_class = () => {
  return (
    <div>
      <p>1. Info mã EB_12345</p>
      <p>
