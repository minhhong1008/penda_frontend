...
const facebook_info = () => {
  ...
  const onFinish = async (values) => {
    const newValue = {
      ...
      facebookdate_start: dateData?.facebook_date_start
        ? moment(dateData.facebook_date_start).format("MM-DD-YYYY")
        : "",
      facebookdate_verify: dateData?.facebook_date_verify
  ...
  const listInfo = [
    ...
    },
    {
      title: "BANK",
      thumbnail:
        "https://previews.123rf.com/images/alexwhite/alexwhite1609/alexwhite160904656/62626176-facebook-flat-design-yellow-round-web-icon.jpg",
      value: "",
    },
    {
      title: "PAYONEER",
  ...
  const listDate = [
...

    {
      ...
      value: "facebookdate_expectedseller",
    },
    {
      title: "Dự kiến list 1",
      value: "facebookdate_expectedlist1",
    },
    {
      title: "Dự kiến list 2",
      value: "facebookdate_expectedlist2",
    },
    {
      title: "Dự kiến list 3",
      value: "facebookdate_expectedlist3",
    },
    {
      title: "Dự kiến list 4",
      value: "facebookdate_expectedlist4",
    },
    {
      title: "Dự kiến list 5",
      value: "facebookdate_expectedlist5",
    },
              ...
              <Card title="THÔNG TIN FACEBOOK">
                ...
                >
                  <Row gutter={16}>
                    <Col span={6}>
                      <Form.Item
                        ...
                        onClick={() =>
                          copyToClipboard(form.getFieldValue("facebook_id"))
                        }
                      >
                        <Input
                          disabled={true}
                  ...
                  <Row gutter={16}>
                    ...
                    <Col span={6}>
                      <Form.Item label="facebook Feedback" name="facebook_feedback">
                        <Input size="small" placeholder="0" />
                      </Form.Item>
                    </Col>
                  </Row>
