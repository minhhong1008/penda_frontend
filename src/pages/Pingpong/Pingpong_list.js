...
export const listselect_pingpong_plan = [
  "Phone",
  "PC",
  "Antidetect",
  "Gologin",
...
export const listselect_pingpong_block = [
  "Team 1",
  "Team 2",
  "Team 3",
  "Team 4",
...
export const listselect_pingpong_type = [
  "VN",
  "US",
  "Buyer",
  "Kick Sold",
...
export const listselect_pingpong_sell_status = [
  "Đang chuẩn bị",
  "Đủ điều kiện bán",
  "Bán tài khoản",
  "Đang giao dịch",
...
export const listselect_pingpong_owner = [
  "Phòng sản xuất",
  "Phòng phục hồi",
  "Phòng Kinh doanh",
  "Phòng nâng cấp",
...
export const listselect_pingpong_class = [
  {
    title: "Lớp 1 New",
    value: "Lớp 1",
  },
...
export const tablelist_pingpong_Date = [
  {
    title: "Ngày giao",
  ...
  },
  {
    ...
    value: "pingpongdate_moveroom",
  },

  {
    title: "Dự kiến seller",
    value: "pingpongdate_calendarseller",
  },
  {
    title: "Dự kiến list 1",
    value: "pingpongdate_calendarlist1",
  },
  {
    title: "Dự kiến list 2",
    value: "pingpongdate_calendarlist2",
  },
  {
    title: "Dự kiến list 3",
    value: "pingpongdate_calendarlist3",
  },
  {
    title: "Dự kiến list 4",
    value: "pingpongdate_calendarlist4",
  },
  {
    title: "Dự kiến list 5",
    value: "pingpongdate_calendarlist5",
  },
  {
    title: "Ngày error",
    value: "pingpongdate_error",
  },
  {
    title: "Ngày restrict",
    value: "pingpongdate_restrict",
  },
  {
...
export const listselect_pingpong_fields = [];


export const HuongDanPingpong_info = () => {
  return (
    <div>
...
export const HuongDanPingpong_table = () => {
  return (
    <div>
      <p>1. Ebay mã EB_12345</p>
      <p>
...
export const HuongDanPingpong_class = () => {
  return (
    <div>
      <p>1. Ebay mã EB_12345</p>
      <p>
...
export default ContentPingpong;
/*   const listTest1 = () => {
    let listTest = [];
    for (var i = 0; i < 10; i++) {
      listTest.push({
