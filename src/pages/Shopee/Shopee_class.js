...
import { HuongDanShopee_class } from "./Shopee_list";
const Shopee_class = () => {
    ...
    },
    {
      ...
      content_complete: (
        <div>
          ...
          <br></br>Etsy, shopee, shopee, amazone..
        </div>
      ),
      content_check: (
        <div>
    ...
    },
    {
      ...
      content_complete: (
        <div>
          ...
          <br></br>Etsy, shopee, shopee, amazone, payoneer, paypal
        </div>
      ),
      content_time: <div>1 ngày</div>,
      content_check: (
            ...
            <Card type="inner">
              ...
              onRow={(text, rowIndex) => {
                return {
                  onClick: (event) => {
                    history.push(
                      `shopee_class/table?class=${encodeURIComponent(
                        text.class
                      )}`
                    );
                  },
