...
// Hàm để gửi dữ liệu đi
  const onFinish = async (values) => {
    const newValue = {
      ...
      shopee_date_start: dateData?.shopee_date_start
        ? moment(dateData.shopee_date_start).format("MM-DD-YYYY")
        : "",
      shopee_date_verify: dateData?.shopee_date_verify
        ? moment(dateData.shopee_date_verify).format("MM-DD-YYYY")
        : "",
...
// Hàm gọi dữ liệu về từ database
  const getInfoshopee = async () => {
    ...
    const newData = {
      ...data,
      shopee_employee: data.shopee_employee.split(","),
      shopee_processing: data.shopee_processing.split(","),
      shopee_type: data.shopee_type.split(","),
      shopee_sell_status: data.shopee_sell_status.split(","),
      shopee_owner: data.shopee_owner.split(","),
    };
    form.setFieldsValue(newData);
    infoForm.setFieldsValue(newData);
    dateForm.setFieldsValue({
      shopee_date_start: moment(data.shopee_date_start),
      shopee_date_verify: moment(data.shopee_date_verify),
    });
    setInfo(data);
...
// Hàm để chuyển trang sang các tài khoản khác
  ...
  const listDate = [
    {
      title: "Ngày tạo",
      value: "shopee_date_start",
    },
    {
      title: "Ngày verify",
      value: "shopee_date_verify",
    },
  ];
              ...
              <Card title="THÔNG TIN ETSY">
                ...
                >
                  <Row gutter={16}>
                    ...
                    <Col span={10}>
                      <Form.Item label="shopee User" name="shopee_user">
                        <Input size="small" placeholder="input here" />
                      </Form.Item>
                    </Col>
                    <Col span={8}>
                    ...
                    <Col span={12}>
                      <Form.Item label="Lớp shopee" name="shopee_class">
                        ...
                        >
                          ...
                          <Option value="Lớp 20" label="Lớp 20 shopee error">
                            <div className="demo-option-label-item">
                              Lớp 20 shopee error
                            </div>
                          </Option>
                          <Option value="Lớp 21" label="Lớp 21 shopee die">
                            <div className="demo-option-label-item">
                              Lớp 21 shopee die
                            </div>
                          </Option>
