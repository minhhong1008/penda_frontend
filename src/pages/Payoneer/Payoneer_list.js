...
export const listselect_payoneer_error = ["Xong","error login", "Sai pass","error code","code 1h","Request selfie","Request Address","Không thấy sim","error verify"];
...
export const listselect_payoneer_plan = [
  "Phone",
  "PC",
  "Antidetect",
  "Gologin",
...
export const listselect_payoneer_block = [
  "Team 1",
  "Team 2",
  "Team 3",
  "Team 4",
...
export const listselect_payoneer_owner = [
  "Phòng sản xuất",
  "Phòng phục hồi",
  "Phòng Kinh doanh",
  "Phòng nâng cấp",
...
export const listselect_payoneer_class = [
  {
    title: "Lớp 1 New",
    value: "Lớp 1",
  },
...
export const tablelist_payoneer_Date = [
  {
    title: "Ngày giao",
  ...
  },
  {
    ...
    value: "payoneerdate_moveroom",
  },

  {
    title: "Dự kiến seller",
    value: "payoneerdate_calendarseller",
  },
  {
    title: "Dự kiến list 1",
    value: "payoneerdate_calendarlist1",
  },
  {
    title: "Dự kiến list 2",
    value: "payoneerdate_calendarlist2",
  },
  {
    title: "Dự kiến list 3",
    value: "payoneerdate_calendarlist3",
  },
  {
    title: "Dự kiến list 4",
    value: "payoneerdate_calendarlist4",
  },
  {
    title: "Dự kiến list 5",
    value: "payoneerdate_calendarlist5",
  },
  {
    title: "Ngày error",
    value: "payoneerdate_error",
  },
  {
    title: "Ngày restrict",
    value: "payoneerdate_restrict",
  },
  {
...
export const listselect_payoneer_fields = [];


export const HuongDanPayoneer_info = () => {
  return (
    <div>
...
export const HuongDanPayoneer_table = () => {
  return (
    <div>
      <p>1. Ebay mã EB_12345</p>
      <p>
...
export const HuongDanPayoneer_class = () => {
  return (
    <div>
      <p>1. Ebay mã EB_12345</p>
      <p>
...
export default ContentPayoneer;
/*   const listTest1 = () => {
    let listTest = [];
    for (var i = 0; i < 10; i++) {
      listTest.push({
