    ...
    <>
      {page == "HomePage" ? null : (
        <Menu theme="light" mode="inline">
          ...
          <Menu.Item key="2">
            <NavLink to="/personnel/users_class">
              <span
                className="icon"
                style={{
                  background: page === "personnel/users_class" ? color : "",
                }}
              >
                {dashboard}
              </span>
          ...
          <Menu.Item key="2">
            <NavLink to="/personnel/users_timesheets">
              <span
                className="icon"
                style={{
                  background: page === "personnel/users_timesheets" ? color : "",
                }}
              >
                {dashboard}
              </span>
          ...
          <Menu.Item key="3">
            <NavLink to="/blog/review_class">
              <span
                className="icon"
                style={{
                  background: page === "blog/review_class" ? color : "",
                }}
              >
                {dashboard}
              </span>
